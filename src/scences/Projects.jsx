            ...
            variants={{
                ...
                <div>
                    <p className='font-semibold text-4xl '>
                        <span className='text-custom-color'>PRO</span>JECTS 
                    </p>
                    <div className='flex justify-center mt-5'>
                        <LineGradient width='w-1/3' />
                    </div>
                </div>
                <p className='mt-10 mb-10'>Lorem ipsum dolor sit amet. Lorem, ipsum dolor sit amet consectetur adipisicing elit. Consequuntur quisquam nam laborum.</p>
            </motion.div>
            {/* Projects */}
