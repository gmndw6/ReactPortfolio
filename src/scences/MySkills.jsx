    ...
    <section id="skills" className="pt-10 pb-24">
        ...
        <div className="md:flex md:justify-between md:gap-16 mt-32">
            ...
            variants={{
                ...
                <p className='font-semibold text-4xl mb-5'>
                    MY <span className='text-custom-color'>SKILLS</span>
                </p>
                <LineGradient width='w-1/3' />
                <p className='mt-10 mb-7'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Consequuntur quisquam nam laborum.</p>
            </motion.div>
            <div className="mt-16 md:mt-0">
                { isAboveMediumScreens ? (
                    ...
                    >
                        <img src="assets/skills-image.png"
                        alt="skills"
                        className='z-10'
                        />
                    </div>
        ...
        <div className="md:flex md:justify-between mt-16 gap-32">
            ...
            >
                ...
                <p className="mt-5">
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Expedita iste, fuga nisi magnam aliquam veritatis aut facilis porro pariatur distinctio!
                </p>
            </motion.div>
